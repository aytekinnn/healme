    ...
    <div class="container">
        <div class="row py-1 py-md-2 px-lg-0">
                ...
                <div class="row flex-column flex-md-row flex-lg-column">
                    <div class="col-md col-lg-auto">
                        <div class="footer-logo">
                            <img width="45%" src="images/heal-me-tour-logo.png" alt="" class="img-fluid">
                        </div>
                    ...
                    <div class="col-md">
                        <div class="footer-text mt-1 mt-lg-2">
                            <!-- <p>Şirketimiz Dr. Ferhat Kayan tarafından kurulmuş olup, Ferhat Bey 1977
                                <br>Konya Maarif Koleji, 1984 yılı Ankara Üniversitesi Tıp Fakültesi mezunudur.
                            </p> -->
            ...
            <div class="col-sm-6 col-lg-4">
                <h3>Heal Me Tour Hakkında</h3>
                <div class="h-decor"></div>
                <ul class="flex-column nav">
                    <li class="nav-item"><a class="nav-link" href="hastaneler">Hastaneler</a></li>
                    <!-- <li class="nav-item"><a class="nav-link" href="https://www.evisa.gov.tr/tr/" target="_blank">E-Visa</a></li> -->
                    <li class="nav-item"><a class="nav-link" href="nasil-yapiyoruz">Nasıl Yapıyoruz ?</a></li>
                    <li class="nav-item"><a class="nav-link" href="tedaviler">Tedaviler</a></li>
                    <!-- <li class="nav-item"><a class="nav-link" href="neden-healme-tour">Neden Heal Me Tour ?</a></li> -->
            ...
            <div class="col-sm-6 col-lg-4">
                ...
                <div class="h-decor"></div>
                <ul class="icn-list">
                    <li><i class="icon-placeholder2"></i>Kızılarık Mah.2754 Sok. No:1 İç Kapı No:212 Muratpaşa-Antalya
                        <br>
                        <a href="#" class="btn btn-xs btn-gradient"><i class="icon-placeholder2"></i><span>Haritalarda Göster</span><i class="icon-right-arrow"></i></a>
                    </li>
                    <li><i class="icon-telephone"></i><b><span class="phone"><a href="tel:02423260027"><span class="text-nowrap">+90 242 326 00 27</span></a></span></b>
                        <br>
                    </li>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row text-center text-md-left">
                <div class="col-sm">Copyright © 2022 <a href="https://aytekinbagci.com" target="_blank">Aytekin Bağcı</a><span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
