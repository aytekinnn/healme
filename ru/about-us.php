    ...
    <div class="section page-content-first">
        <div class="container">
            <div class="text-center mb-2  mb-md-3 mb-lg-4">
                <div class="h-sub theme-color">Heal Me Tour</div>
                <h1>О нас</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 text-center text-lg-left pr-md-4 mb-8">
                    <img src="images/hakkimizda-1.jpg" class="w-100" alt="">
                    <div class="row mt-3">
                        <div class="col-6">
                            <img src="images/hakkimizda-2.jpg" class="w-100" alt="">
                        </div>
                        <div class="col-6">
                            <img src="images/hakkimizda-3.jpg" class="w-100" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mt-3 mt-lg-0 mt-2">
                    <p class="mt-6">Наша компания была основана Доктором  Ферхат Каяном, который окончил Конья-Маариф-колледж в 1977 году и медицинский факультет Университета Анкары в 1984 году.  Он работал на разных этапах сектора здравоохранения, как государственного, так и частного, и специализировался на туристическом здоровье и оздоровительном туризме.</p>
                    <p>Он играл активную роль в создании и управлении частной больницы «Özel Aspendos Hastanesi»и в течение восьми лет руководил ею.  Между тем, Анталия всегда сотрудничала с курортами и отелями туристического региона в вопросах здоровья туристов.  В настоящее время он продолжает работать во всех направлениях оздоровительного туризма, от медицинского туризма до спортивного туризма, от термального туризма до ухода за детьми третьего курса и туризма для инвалидов. </p>
                    <p> Основатель нашей компании, Др. Ферхат Каян и наши опытные деловые партнеры, мы оцениваем методы лечения людей из разных стран и культур с помощью нашего опыта в результате тестов и обследований и гарантируем их безопасное применение с использованием самых передовых и правильных методов лечения.</p>
        ...
        <div class="row mb-6">
            ...
            <div class="col-md-9">
                <ul class="marker-list-md">
                    <li>Потому что мы знаем цену нашему опыту, накопленному годами, и доверию, которое он дает.</li>
                    <li>Поскольку мы применяем технологические требования, оценивая их индивидуально</li>
                    <li>Поскольку человеческое здоровье и покой ценны, нам нравится придавать им необходимое значение.</li>
                    <li>Потому что мы работаем над тем, чтобы поднять нашу страну еще выше в области здравоохранения.</li>
                    <li>Потому что мы всегда открыты для инноваций</li>
                    <li>Потому что для нас каждый человек особенный сам по себе.</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <p>Our dental office in is a state of the art dental facility equipped with the newest technology, capable of handling all of your dental needs. All of our operatories are equipped with intraoral cameras that are able to show us,
                        and you, the precise treatment you might attain on a television screen.</p>
                    <div class="mt-4"></div>
                    <h3>Amenities</h3>
